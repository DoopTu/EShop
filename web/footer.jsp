<%-- 
    Document   : footer
    Created on : Oct 2, 2022, 7:35:39 PM
    Author     : LENOVO
--%>
            ...
            <div class="row px-xl-5 pt-5">
                <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    <a href="" class="text-decoration-none">
                        <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">E</span>Plant</h1>
                    </a>
...
<!--            <div class="row border-top border-light text-left mx-xl-5 py-4">
                <div class="col-md-6 px-xl-0 text-right text-md-right">
